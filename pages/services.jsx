...
const Services = () => {
    return (
        <div>
            <AntpslzgBreadcrumb pathArr={[{title: 'Usługi'}]}/>
            <Banner backgroundImage='linear-gradient(180deg, #ffffff 0%,rgba(255,255,255,0) 100%),url(/images/stairs.png)' withwaves={false}>
