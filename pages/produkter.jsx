...
const Products = () => {
    return (
        <>
            ...
            <Meta
                title='Profesjonelle midler til sklisikring av gulv'
                description='Profesjonelle og miljøvennlige produkter innen sklisikring, impregnering, og rengjøring av overflater'
            />
            ...
            <div className={styles.frictionMeasurement}>
                ...
                <div className={styles.pageBody}>
                    <div className={styles.left}>
                        ...
                        <p>&nbsp;</p>
                        <p>Vannbaserte preparater beregnet for fjerning av veldig vanskelig, gammelt smuss, samt enkelte flekker. Profesjonelle produkter som garanterer 100% effekt uten risiko for misfarging eller skading av overflater. Preparater er beregnet for fjerning av veldig sterkt mineralsk eller organisk smuss.</p>
