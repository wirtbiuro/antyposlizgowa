    ...
    <>
      ...
      <div className={styles.all}>
        ...
        <div className={otherStyles.pageBody}>
          ...
          <div className={`${styles.pageBody} ${otherStyles.innerPageBody}`}>
            <div className={`${styles.left} ${otherStyles.left}`} ref={imgRef}>
              <img
                src="/images/measurement-3.png"
                className={styles.decorImg}
              />
            </div>
            <div
              className={`${styles.right} ${otherStyles.right}`}
              ref={textRef}
            >
              <h2>Leder innen sklisikring</h2>
              <p>&nbsp;</p>
              <p>
                Dyktighandverker AS er forhandler av profesjonelle kjemiske
                preparater fra CTS Chemistry. Vi garanterer kvalitet og
                sklisikringens mangeårige holdbarhet. Vi bruker antiskli
                preparater som bygger på egne og sertifiserte oppskrifter, samt
                vi arbeider i henhold til den patenterte teknologien ZAP®.
              </p>
              <p>
                Vi sikrer både våte og glatte overflater, både før og etter
                montering.
                {/* <br/>
                                Wykonujemy <strong>pomiar antypoślizgowości według wytycznych Instytutu Techniki Budowlanej.</strong> */}
              </p>
              <p>
                Etter at vi er ferdig med arbeidene, måler vi sklisikkerhet og
                vi utsteder et samsvarsertifikat for den gjennomførte
                undersøkelsen.
              </p>
              <p>
                Våre tjenester er effektive og trygge, som de eneste på markedet
                endrer de ikke overflatens stil.{" "}
              </p>
              <p>
                Uten oppussing eller bruk av stygge remser, tape eller Uten
                oppussing eller bruk av stygge taper, klistremerker og
                antisklimatte, kan vi gjøre hvilken som helst overflate til en
                ren og trygg overflate.{" "}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className={otherStyles.pageBody}>
          <div className={`${styles.pageBody} ${otherStyles.innerPageBody}`}>
            <div
              className={`${styles.left} ${otherStyles.left}`}
              ref={textRef2}
            >
              ...
              <ul>
                <li>
                  <p>
                    Vi er det eneste firmaet i Norge som bruker produktene fra
                    CTS Chemistry. De bidrar til den høye kvaliteten til våre
                    tjenester.
                  </p>
                </li>
                <li>
                  <p>
                    Vi har en individuell tilnærming til hvert oppdrag, og vi
                    setter kundenes behov og ønsker i fokus.
                  </p>
                </li>
                <li>
                  <p>
                    Vi gjennomfører både et enkelt oppdrag, samt faste oppdrag
                    med grunnlag i et samarbeidsavtale.
                  </p>
                </li>
              </ul>
            </div>
